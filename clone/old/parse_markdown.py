...
# Basic sanitization: remove long binary/base64-like blobs and
# non-printable control characters that confuse LLM parsers.
def sanitize_markdown(text: str) -> str:

    # Remove very long runs of non-whitespace characters (likely base64/binary)
    ...
    # Truncate extremely large documents to a safe size for the LLM
    if len(text) > 200000:
        text = text[:200000]
