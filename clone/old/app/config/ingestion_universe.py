...
QUERY_PATTERNS = [
    "{sector} {term}",
    "{sector} {stage} investors",
    "{sector} {stage} venture capital",
    "{sector} investors in {geography}",
    "{sector} venture capital firms in {geography}",
    "{geography} {sector} startup investors",
    "{theme} investors",
    "{theme} venture capital firms",
    "{theme} startup investors",
    "{theme} VC funds",
    "{theme} {sector} investors",
    "{theme} {sector} venture capital",
    "{sector} portfolio companies",
    "{sector} investment thesis",
    "{sector} startup ecosystem investors",
    "{sector} startup funding firms",
    "{sector} startup accelerators",
    "{sector} startup investment platforms",
]
